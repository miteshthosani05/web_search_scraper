...
public class BingSearchProviderParameterizedTest {
	...
	public BingSearchProviderParameterizedTest(ISearchService<SearchRequest,String> searchService, String searchString, int expectedNumberOfResults){
	...
	@Test
	public void testBingSearchProvider(){
		SearchProvider searchProvider = new BingSearchProvider(searchString,searchService);
